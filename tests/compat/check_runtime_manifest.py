#!/usr/bin/env python3
"""Verify audited runtime policy in the compatibility manifest."""
...
CORE_POLICIES = [
    ...
    },
    {
        ...
        "soname": "libc.so.6",
        "binding": "global",
        "implementation": "musl-bsd-core:ftruncate64",
        "test": "compat/fs64_abi",
        "quality": "EXACT",
    },
    {
        "name": "statfs64",
        ...
        "soname": "libc.so.6",
        "binding": "global",
        "implementation": "musl-bsd-core:statfs64",
        "test": "compat/fs64_abi",
        "quality": "EXACT",
    },
    {
...
LIBC_POLICIES = [
    ...
    },
    {
        ...
        "soname": "libc.so.6",
        "binding": "global",
        "implementation": "musl-libc:access",
        "test": "compat/access_abi",
        "quality": "EXACT",
    },
    {
        "name": "acos",
