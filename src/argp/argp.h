...
extern void argp_usage(const struct argp_state* __state) __THROW;
extern void __argp_usage(const struct argp_state* __state) __THROW;

/* If appropriate, print the printf string FMT and following args, preceded
   by the program name and `:', to stderr, and followed by a `Try ... --help'
   message, then exit (1).  */
extern void argp_error(const struct argp_state* __restrict __state,
                       const char* __restrict __fmt, ...) __THROW
...
extern void* _argp_input(const struct argp* __restrict __argp, const struct argp_state* __restrict __state) __THROW;
...
/* Getting the short program name */
extern char* _argp_short_program_name(void) __THROW;
extern char* __argp_short_program_name(void) __THROW;
