...
/* If appropriate, print the printf string FMT and following args, preceded
   ...
   message, then exit (1).  */
extern void argp_error(__const struct argp_state* __restrict __state, __const char* __restrict __fmt, ...) __THROW
    PRINTF_STYLE(2, 3);
extern void __argp_error(__const struct argp_state* __restrict __state, __const char* __restrict __fmt, ...) __THROW
    PRINTF_STYLE(2, 3);
...
extern void* _argp_input(__const struct argp* __restrict __argp, __const struct argp_state* __restrict __state) __THROW;
